                ...
                db.query('SELECT * FROM Candidatos').then(function(result){
                    ...
                    if (result.length > 0) {
                        ...
                        consulta        = "INSERT INTO `Candidatos` VALUES('1','keinny Suzette', 'Ferrer Quirife', 'F', '11', '1' ,'images/users/2.jpg', 1), " +
                                                                  ...
                                                                  "('10','Voto', 'En Blanco', 'M', '11' , '4','images/users/voto-blanco.jpg', 1),"+
                                                                  "('11','Voto', 'En Blanco', 'M', '11' , '4','images/users/voto-blanco.jpg', 2),"+
                                                                  "('12','Voto', 'En Blanco', 'M', '11' , '4','images/users/voto-blanco.jpg', 3)";
